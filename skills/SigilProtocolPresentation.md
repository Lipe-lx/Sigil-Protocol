...
## Important Reminders
- ⚠️ CRÍTICO: O Sigil Protocol opera exclusivamente na Devnet da Solana para este ciclo.
- ⚠️ CRÍTICO: Toda a reputação é baseada em comportamento on-chain auditável.
